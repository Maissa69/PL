...
public class CalculateMathExpression {
    ...
    public static void  Calculate(boolean forMax){
        ...
        var v = new SimplexAlgo(CalculateMathExpression.Coefs,CalculateMathExpression.allVarsOfEachExp,CalculateMathExpression.allVars, CalculateMathExpression.B,forMax);
        v.ShowMatrix();
        v.ShowB();
    ...
    private void setPoints(){
         ...
         this.point1.Y = 0;
         this.point1.X =  (double) -Coef.getLast() /Coef.getFirst() * 0;
         this.point2.Y = 10;
         this.point2.X =  (double) -Coef.getLast() /Coef.getFirst() * 10;
    }
