...
public class SimplexAlgo {
    ...
    public void ShowSolutions(){
        ...
        for (int i = 0 ; i< Solutions.length ; i++) {
            System.out.println(ALL_VARS.get(i) + " = " + Solutions[i]);
        }
    }

    public void StartAlgo(int NumberOfVars){
        int i = 0;


        Solutions = new double[NumberOfVars];
    ...
    public static Point getPoint(int x, LinkedList<Integer> Coefs,Integer B){
        var point = new Point();
        point.X = x;
        point.Y = (double) (B - Coefs.getFirst() * x) / Coefs.get(1);
        return point;
    }
